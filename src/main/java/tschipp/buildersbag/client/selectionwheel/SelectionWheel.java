...
//
//public class SelectionWheel TODO
//{
...
//	private static ItemRenderer itemRender = mc.getItemRenderer();
//
...
//		mc.getTextureManager().bind(VANILLA);
//
//	}
//
...
//					mc.player.playSound(SoundEvents.NOTE_BLOCK_HAT, 0.5f, 0.1f);
//			}
//			else
//			{
...
//
//				if (Configs.Settings.playPickBlockSounds.get())
//					mc.player.playSound(SoundEvents.NOTE_BLOCK_HAT, 0.5f, 0.7f);
//
...
//			separate(119 - mc.font.width(page), 240, () ->
//			{
//				GlStateManager.scale(2, 2, 2);
//				mc.font.drawShadow(page, 0, 0, 0xFFFFFF);
//			});
//
//			for (int i = 0; i < currentPage.items.size(); i++)
//			{
...
//					{
//						GlStateManager.scale(1.5, 1.5, 1.5);
//						drawHoveringText(I18n.translateToLocalFormatted("buildersbag.selectionwheel.selectblock", currentStack.getHoverName()), I18n.translateToLocalFormatted("buildersbag.selectionwheel.changepalette", add ? TextFormatting.GREEN : TextFormatting.RED, add ? I18n.translateToLocal("buildersbag.module.add") : I18n.translateToLocal("buildersbag.module.remove"), currentStack.getHoverName(), add ? I18n.translateToLocal("buildersbag.module.to") : I18n.translateToLocal("buildersbag.module.from")));
//					});
//				}
//			}
//		}
...
//	{
//		GuiUtils.drawHoveringText(Lists.newArrayList(lines), 0, 0, res.getScaledWidth() * res.getScaleFactor(), res.getScaledHeight() * res.getScaleFactor(), 300, mc.font);
//		mc.getTextureManager().bind(TEXTURE);
//		RenderHelper.turnOff();
//		GlStateManager._enableBlend();
//	}
...
//				{
//					if(ItemStack.matches(selPage.items.get(j), selected))
//					{
...
//			{
//				if (ItemStack.matches(selected, palette.get(j)))
//				{
//					palette.remove(j);
//					break;
//				}
