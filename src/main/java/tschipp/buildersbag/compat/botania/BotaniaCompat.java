...
//
//public class BotaniaCompat TODO
//{
...
//		if (nbt.equals(lastTag) && ItemStack.isSame(lastSelected, requestedStack) && lastCount != 0)
//			return lastCount;
//
//		if (player.level.isClientSide || (rand.nextDouble() < 1 && ItemStack.isSame(lastSelected, requestedStack) && lastCount != 0))
//		{
//			if (lastCount != 0)
//				lastCount--;
//			return lastCount;
